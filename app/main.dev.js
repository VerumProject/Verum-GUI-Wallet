...
const directories = [`${homedir}/.verumwallet`, `${homedir}/.verumwallet/logs`];
...
const daemonLogFile = path.resolve(directories[1], 'verum.log');
...
app.on('ready', async () => {
  ...
  mainWindow = new BrowserWindow({
    title: `Verum Wallet v${version.toString()}`,
    useContentSize: true,
    width: 1200,
    height: 625,
    minWidth: 1200,
